...
If !( o7z := 7Zip_Init() )
{
  msgbox % "Failed loading 7-zip64.dll library"
  ExitApp
}

fileName := "d:\download\zipTest.zip"

msgbox % "fileCount : " 7Zip_GetFileCount( fileName )
msgbox % "version   : " 7Zip_GetVersion()
msgbox % "list      : " 7Zip_List( fileName )
...
------------------------------------------------------------------------------------------------------------------------------- 
*/
7Zip_Init( sDllPath = "7-zip64.dll" ) {
  global 7Zip_
  If 7Zip_._hModule
    return 7Zip_
...
7Zip_SetOwnerWindowEx(sProcFunc, hWnd=0) {
  ...
  Return DllCall("7-zip64\SevenZipSetOwnerWindowEx","Ptr", hWnd , "ptr", Address)
} ;End Function
...
7Zip_KillOwnerWindowEx(hWnd) {
  Return DllCall("7-zip64\SevenZipKillOwnerWindowEx" , "Ptr", hWnd)
} ;End Function
...
7Zip_CheckArchive(sArcName) {
  Return DllCall("7-zip64\SevenZipCheckArchive", "AStr", sArcName, "int", 0)
} ;End Function
...
7Zip_GetArchiveType(sArcName) {
  Return DllCall("7-zip64\SevenZipGetArchiveType", "AStr", sArcName)
} ;End Function
...
7Zip_GetFileCount(sArcName) {
  Return DllCall("7-zip64\SevenZipGetFileCount", "AStr", sArcName)
} ;End Function
...
7Zip_ConfigDialog(hWnd) {
  Return DllCall("7-zip64\SevenZipConfigDialog", "Ptr", hWnd, "ptr",0, "int",0)
} ;End Function

7Zip_QueryFunctionList(iFunction = 0) {
  Return DllCall("7-zip64\SevenZipQueryFunctionList", "int", iFunction)
} ;End Function
...
;
7Zip_GetVersion() {
  aRet := DllCall("7-zip64\SevenZipGetVersion", "Short")
...
;
7Zip_GetSubVersion() {
  return DllCall("7-zip64\SevenZipGetSubVersion", "Short")
} ;End Function
...
7Zip_OpenArchive(sArcName, hWnd=0) {
  Return DllCall("7-zip64\SevenZipOpenArchive", "Ptr", hWnd, "AStr", sArcName, "int", 0)
} ;End Function
...
;
7Zip_CloseArchive(hArc) {
  Return DllCall("7-zip64\SevenZipCloseArchive", "Ptr", hArc)
} ;End Function
...
7Zip_FindFirst(hArc, sSearch, o7zip__info="") {
  if (o7zip__info = 0)
  {
    r := DllCall("7-zip64\SevenZipFindFirst", "Ptr", hArc, "AStr", sSearch, "ptr", 0)
  ...
  If DllCall("7-zip64\SevenZipFindFirst", "Ptr", hArc, "AStr", sSearch, "ptr", &tINDIVIDUALINFO)
    Return 0
...
7Zip_FindNext(hArc, o7zip__info="") {
  ...
  if !IsObject(o7zip__info)
    o7zip__info := Object()
  VarSetCapacity(tINDIVIDUALINFO , 558, 0)
  if DllCall("7-zip64\SevenZipFindNext","Ptr", hArc, "ptr", &tINDIVIDUALINFO)
    Return 0 
...
7Zip_GetFileName(hArc) {
  ...
  If !DllCall("7-zip64\SevenZipGetFileName", "Ptr", hArc, "ptr", &tNameBuffer, "int", 513)
    Return StrGet(&tNameBuffer,513,"CP0")
} ;End Function

7Zip_GetArcOriginalSize(hArc) {
  Return DllCall("7-zip64\SevenZipGetArcOriginalSize", "Ptr", hArc)
} ;End Function

7Zip_GetArcCompressedSize(hArc) {
  Return DllCall("7-zip64\SevenZipGetArcCompressedSize", "Ptr", hArc)
} ;End Function

7Zip_GetArcRatio(hArc) {
  Return DllCall("7-zip64\SevenZipGetArcRatio", "Ptr", hArc, "short")
} ;End Function

7Zip_GetDate(hArc) {
  Return 7Zip_DosDate(DllCall("7-zip64\SevenZipGetDate", "Ptr", hArc, "Short"))
} ;End Function

7Zip_GetTime(hArc) {
  Return 7Zip_DosTime(DllCall("7-zip64\SevenZipGetTime", "Ptr", hArc, "Short"))
} ;End Function

7Zip_GetCRC(hArc) {
  Return DllCall("7-zip64\SevenZipGetCRC", "Ptr", hArc, "UInt")
} ;End Function

7Zip_GetAttribute(hArc) {
  return DllCall("7-zip64\SevenZipGetAttribute", "Ptr", hArc)
} ;End Function

7Zip_GetMethod(hArc) {
  VarSetCapacity(sBUFFER,8)
  if !DllCall("7-zip64\SevenZipGetMethod" , "Ptr", hArc , "ptr", &sBuffer,"int", 8)
...
7Zip__SevenZip(sCommand) {
  ...
  aRet := DllCall("7-zip64\SevenZip", "Ptr", hWnd
          ,"AStr", sCommand
          ,"Ptr", &tOutBuffer
          ,"Int", nSize)
  If !ErrorLevel
